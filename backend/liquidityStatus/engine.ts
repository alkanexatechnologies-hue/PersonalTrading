...
export async function evaluateLiquidityStatus(symbol: string, deps: LiquidityStatusDeps): Promise<LiquidityStatusResult> {
  ...
  return {
    ...
    structure: { ema9: structure.ema9, ema21: structure.ema21, ema50: structure.ema50, emaStructure: structure.emaStructure, vwapStatus: structure.vwapStatus, vwapValue: structure.vwapValue },
